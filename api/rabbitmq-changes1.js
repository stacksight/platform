...
module.exports.consume = function (queueName, maxUnackedMessagesAmount, callback, noAck) {
  // create queue if not exists
  var noAck = (typeof noAck !== 'undefined') ? noAck : true;
       ...
       /* if (currentTransmissionNum > MAX_RESEND_ATTEMPTS) {
          ...
          setTimeout(function () {*/
            ...
            callback(messageContent,
              function err() {
                if (!noAck) channel.ack(msg, false, false);
