...
angular.module('mean.users')
    ...
    .controller('LoginCtrl', ['$scope', '$rootScope', '$http', '$state', 'Global',
        function($scope, $rootScope, $http, $state, Global) {
    ...
    .controller('RegisterCtrl', ['$scope', '$rootScope', '$http', '$state', 'Global',
        function($scope, $rootScope, $http, $state, Global) {
            $scope.user = {};
            $scope.global = Global;
    ...
    .controller('ResetPasswordCtrl', ['$scope', '$rootScope', '$http', '$state', '$stateParams', 'Global',
        function($scope, $rootScope, $http, $state, $stateParams, Global) {
            $scope.user = {};
            $scope.global = Global;
            $scope.global.registerForm = false;
