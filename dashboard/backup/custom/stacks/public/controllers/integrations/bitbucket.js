...
/* jshint -W098 */
angular.module('mean.stacks').controller('IntegrationsBitbucketController', ['$scope', 'Global', 'Stacks', 'Appsun', '$stateParams', 'MeanSocket',
    function($scope, Global, Stacks, Appsun, $stateParams, MeanSocket) {

        var vmibb = this;
        vmibb.global = Global;
        vmibb.cmd = 'https://api.stacksight.io/v0.1/integrations/bitbucket?token=' + vmibb.global.user.profile.token + '&stackId=' + $scope.stack._id;
