...
angular.module('mean.stack')
    .controller('HealthController', ['$scope', 'Global', 'Stacks', 'Appsun', '$stateParams', 'MeanSocket', '$timeout', '$interpolate', '$filter', '$state', '$rootScope', '$location', '_', 'Sapi', 'Health', 'Availability',
        function($scope, Global, Stacks, Appsun, $stateParams, MeanSocket, $timeout, $interpolate, $filter, $state, $rootScope, $location, _, Sapi, Health, Availability) {
            ...
            $scope.templates = {
                meter: 'stack/views/health/meter.html',
                availability: 'stack/views/health/availability.html',
                checklist: 'stack/views/health/checklist.html',
                backup: 'stack/views/health/backup.html',
                pointslist: 'stack/views/health/pointslist.html',
                performance: 'stack/views/health/performance.html',
                seo_meter: 'stack/views/health/seo_meter.html',
                seo_chart: 'stack/views/health/seo_chart.html',
                seo_detail: 'stack/views/health/seo_detail.html',
                accessibility: 'stack/views/health/accessibility.html'
            };
