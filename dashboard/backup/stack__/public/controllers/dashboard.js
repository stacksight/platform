...
/* jshint -W098 */
angular.module('mean.stack').controller('GroupDashboardController',
    ['$scope', '$filter', '$state', '$location', '$timeout', '$stateParams', '_', 'Health', 'Apps', '$rootScope',
    function($scope, $filter, $state, $location, $timeout, $stateParams, _, Health, Apps, $rootScope) {
        var vmd = this,
            threshold = {},
        ...
        vmd.init = function() {
            console.log($scope);
            // groupStacks = $scope.vmd.app.stacks;
