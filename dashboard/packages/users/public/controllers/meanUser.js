...
angular.module('mean.users')
    ...
    .controller('LoginCtrl', ['$scope', '$rootScope', '$http', '$state', 'Global', 'Companies',
        function($scope, $rootScope, $http, $state, Global, Companies) {
                    ...
                    .success(function(response) {
                        ...
                        if (response.redirect) {
                            ...
                            $state.go('company.main.dashboard', {
                                companyId: Companies.my(response.user.companies).id
                            });
                        }
                        // window.location.reload();
    ...
    .controller('RegisterCtrl', ['$scope', '$rootScope', '$http', '$state', 'Global', 'Companies',
        function($scope, $rootScope, $http, $state, Global, Companies) {
            $scope.user = {};
            $scope.global = Global;
            ...
            $scope.register = function(valid) {
                if (!valid || !$scope.user.tercond) return;
    ...
    .controller('ResetPasswordCtrl', ['$scope', '$rootScope', '$http', '$state', '$stateParams', 'Global', 'Companies',
        function($scope, $rootScope, $http, $state, $stateParams, Global, Companies) {
            $scope.user = {};
            $scope.global = Global;
            $scope.global.registerForm = false;
