...
Stack.register(function(app, auth, database) {
  ...
  Stack.aggregateAsset('css', 'events.css');
  Stack.aggregateAsset('css', 'logs.css');
  Stack.aggregateAsset('css', 'updates.css');
  Stack.aggregateAsset('css', 'integrations.css');
  Stack.aggregateAsset('css', 'settings.css');
  Stack.aggregateAsset('css', 'custom.css');
  Stack.aggregateAsset('css', 'health.css');
  Stack.aggregateAsset('css', 'inventory.css');
  ...
  Stack.aggregateAsset('js', '../lib/d3/d3.min.js', {
    group: 'header'
  });
  ...
  Stack.angularDependencies(['angucomplete-alt', 'angularMoment', 'rzModule', 'chart.js', 'LocalStorageModule', 'ui.select', 'ngSanitize',
    'angular.filter', 'angular-clipboard', 'infinite-scroll', 'indicator', 'mean.general', 'daterangepicker']);
