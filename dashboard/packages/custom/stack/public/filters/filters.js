angular.module('mean.stack').filter('shownProducts', function(Global) {
...
angular.module('mean.stack').filter('propsFilter', function() {
...
angular.module('mean.stack').filter('slice', function() {
    return function(arr, start, end) {
        return arr.slice(start, end);
    };
});
angular.module('mean.stack').filter('bytes', function() {
...
angular.module('mean.stack').filter('googleBase64', function() {
...
angular.module('mean.stack').filter('colorize', function() {
...
angular.module('mean.stack').filter('seotype', function() {
    return function(type) {
        switch (type) {
            case 'good':
                return 'Good';
...
angular.module('mean.stack').filter('icoset', function() {
    return function(type) {
        switch (type) {
            case 'good':
...
angular.module('mean.stack').filter('speedsummary', function($interpolate, $filter) {
