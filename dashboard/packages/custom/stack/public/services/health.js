...
angular.module('mean.stack').factory('Health', ['Sapi', '$q',
    function(Sapi, $q) {
        var latestScoreData = {};
        ...
        return {
            ...
            tabs: function(options) {
                return [{
                    ...
                    noData: 'to view performance data go to <a href="#!/stack/' + options.id + '/settings">settings</a>',
                    server: true,
                    display: true,
                    onClient: false,
                    noexist: {
                    ...
                    noData: 'to view accessibility data go to <a href="#!/stack/' + options.id + '/settings">settings</a>',
                    server: true,
                    display: true,
                    onClient: false,
                    noexist: {
                    ...
                    display: true,
                    onClient: false,
                    noData: 'to view availability data go to <a href="#!/stack/' + options.id + '/settings">settings</a> and set your domain.',
                    noexist: {
                        wordpress: {
                    ...
                    onClient: true,
                    displayIfData: true,
                    noData: 'go to <a href="#!/stack/' + options.id + '/integrations">integrations</a> to add your custom backups.',
                    noexist: {
                        wordpress: {
                            'img': '/stack/assets/img/logo_backup_wp.png',
                            ...
                            'module_description': 'UpdraftPlus simplifies backups (and restoration). Backup into the cloud (Amazon S3 (or compatible), ' +
                            'Dropbox, Google Drive, Rackspace Cloud, DreamObjects, FTP, Openstack Swift, UpdraftPlus Vault and email) and restore with a ' +
                            'single click. Backups of files and database can have separate schedules.'
                        },
                        drupal: {
                            'img': '/stack/assets/img/logo_backup_dp.png',
                    ...
                    noexist: {
                        wordpress: {
                            'img': '/stack/assets/img/logo_seo_wp.png',
                            ...
                            'module_description': 'Yoast SEO plugin goes the extra mile to take care of all the technical optimization, more on ' +
                            'that below, it first and foremost helps you write better content. Yoast SEO forces you to choose a focus keyword when ' +
                            'you\'re writing your articles, and then makes sure you use that focus keyword everywhere.'
                        },
                        drupal: {
                            'img': '/stack/assets/img/logo_seo_dp.png',
                    ...
                    noexist: {
                        wordpress: {
                            'img': '/stack/assets/img/logo_security_wp.png',
                            ...
                            'module_description': 'A COMPREHENSIVE, EASY TO USE, STABLE SECURITY PLUGIN. While wordPress itself is a very ' +
                            'secure platform. However, it helps to add some extra security and firewall to your site by using a security ' +
                            'plugin that enforces a lot of good security practices in a whole new level.'
                        },
                        drupal: {
                            'img': false,
                            ...
                            'module_description': 'Security Review module automates testing for many of the easy-to-make mistakes that ' +
                            'render your site insecure.'
                        }
                    }
                }]
            },
