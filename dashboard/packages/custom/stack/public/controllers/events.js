...
/* jshint -W098 */
angular.module('mean.stack').controller('EventsController', ['$scope', 'Global', 'Appsun', '$stateParams', 'MeanSocket', '$timeout', '$location', '$anchorScroll', 'EventsComponents', 'Events',
